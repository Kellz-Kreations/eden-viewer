...
// Back-compat alias: route removed in favor of `/api/config`
// Keeping a lightweight alias to avoid breaking older clients.
...
function printStartupComplete(protocol, port, addresses) {
  ...
  printLine('    POST /api/config       Save configuration');
  printSeparator();
